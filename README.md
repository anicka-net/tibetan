...
- **662 vocabulary items** with Tibetan definitions (650 with English translations)
- **636 fill-in-the-blank exercises** with answers
...
dictionary covering ~98% of vocabulary. It's just JSON key-value pairs:
